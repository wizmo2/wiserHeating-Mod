...
def convert_from_wiser_schedule(
    schedule_data: dict, schedule_name="", schedule_type=""
):
    """
    ...
    # If not declared get the Type from scchedule
    if schedule_type == "":
...
def convert_to_wiser_schedule(schedule_data: dict, schedule_type=""):
    """
    ...
    # Iterate through each day
    schedule_output = {"Type": schedule_type}
